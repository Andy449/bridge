...
public class CNRReply implements org.apache.thrift.TBase<CNRReply, CNRReply._Fields>, java.io.Serializable, Cloneable, Comparable<CNRReply> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CNRReply");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new CNRReplyStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new CNRReplyTupleSchemeFactory();

  public  java.lang.String text; // required
  public  BBox box; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.BOX, new org.apache.thrift.meta_data.FieldMetaData("box", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, BBox.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CNRReply.class, metaDataMap);
  }
   ...
   */
  public CNRReply(CNRReply other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetText()) {
      this.text = other.text;
    }
    if (other.isSetBox()) {
      this.box = new BBox(other.box);
    }
  ...
  public CNRReply deepCopy() {
    return new CNRReply(this);
  }
  ...
  public CNRReply setText( java.lang.String text) {
    this.text = text;
    return this;
  }
  ...
  public CNRReply setBox( BBox box) {
    this.box = box;
    return this;
  }
  ...
  public CNRReply setConfidence(double confidence) {
    this.confidence = confidence;
    setConfidenceIsSet(true);
    return this;
  }
  ...
  public CNRReply setTxt_img( Image txt_img) {
    this.txt_img = txt_img;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof CNRReply)
      return this.equals((CNRReply)that);
    return false;
  }

  public boolean equals(CNRReply that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(CNRReply other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("CNRReply(");
    boolean first = true;
  ...
  private static class CNRReplyStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CNRReplyStandardScheme getScheme() {
      return new CNRReplyStandardScheme();
    }
  }

  private static class CNRReplyStandardScheme extends org.apache.thrift.scheme.StandardScheme<CNRReply> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CNRReply struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CNRReply struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CNRReplyTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CNRReplyTupleScheme getScheme() {
      return new CNRReplyTupleScheme();
    }
  }

  private static class CNRReplyTupleScheme extends org.apache.thrift.scheme.TupleScheme<CNRReply> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CNRReply struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CNRReply struct) throws org.apache.thrift.TException {
