...
public class NucDLRequest implements org.apache.thrift.TBase<NucDLRequest, NucDLRequest._Fields>, java.io.Serializable, Cloneable, Comparable<NucDLRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("NucDLRequest");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new NucDLRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new NucDLRequestTupleSchemeFactory();

  public  Image brand; // optional
  public  Image cnr; // optional
  public  Image seal; // optional
  public  Image dangerous; // optional
  public  Image goods; // optional
  public  Image goods_label; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(NucDLRequest.class, metaDataMap);
  }
   ...
   */
  public NucDLRequest(NucDLRequest other) {
    if (other.isSetBrand()) {
      this.brand = new Image(other.brand);
    }
    if (other.isSetCnr()) {
      this.cnr = new Image(other.cnr);
    }
    if (other.isSetSeal()) {
      this.seal = new Image(other.seal);
    }
    if (other.isSetDangerous()) {
      this.dangerous = new Image(other.dangerous);
    }
    if (other.isSetGoods()) {
      this.goods = new Image(other.goods);
    }
    if (other.isSetGoods_label()) {
      this.goods_label = new Image(other.goods_label);
    }
  }

  public NucDLRequest deepCopy() {
    return new NucDLRequest(this);
  }
  ...
  public NucDLRequest setBrand( Image brand) {
    this.brand = brand;
    return this;
  }
  ...
  public NucDLRequest setCnr( Image cnr) {
    this.cnr = cnr;
    return this;
  }
  ...
  public NucDLRequest setSeal( Image seal) {
    this.seal = seal;
    return this;
  }
  ...
  public Image getDangerous() {
    return this.dangerous;
  }

  public NucDLRequest setDangerous( Image dangerous) {
  ...
  public Image getGoods() {
    return this.goods;
  }

  public NucDLRequest setGoods( Image goods) {
    this.goods = goods;
    return this;
  }
  ...
  public Image getGoods_label() {
    return this.goods_label;
  }

  public NucDLRequest setGoods_label( Image goods_label) {
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof NucDLRequest)
      return this.equals((NucDLRequest)that);
    return false;
  }

  public boolean equals(NucDLRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(NucDLRequest other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("NucDLRequest(");
    boolean first = true;
  ...
  private static class NucDLRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public NucDLRequestStandardScheme getScheme() {
      return new NucDLRequestStandardScheme();
    }
  }

  private static class NucDLRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<NucDLRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, NucDLRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NucDLRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class NucDLRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public NucDLRequestTupleScheme getScheme() {
      return new NucDLRequestTupleScheme();
    }
  }

  private static class NucDLRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<NucDLRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, NucDLRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, NucDLRequest struct) throws org.apache.thrift.TException {
