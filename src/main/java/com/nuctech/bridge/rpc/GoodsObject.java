...
public class GoodsObject implements org.apache.thrift.TBase<GoodsObject, GoodsObject._Fields>, java.io.Serializable, Cloneable, Comparable<GoodsObject> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GoodsObject");
  ...
  private static final org.apache.thrift.protocol.TField IMG_FIELD_DESC = new org.apache.thrift.protocol.TField("img", org.apache.thrift.protocol.TType.STRUCT, (short)3);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new GoodsObjectStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new GoodsObjectTupleSchemeFactory();

  public  java.lang.String label; // required
  public  java.lang.String description; // required
  public  Image img; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GoodsObject.class, metaDataMap);
  }
   ...
   */
  public GoodsObject(GoodsObject other) {
    ...
    if (other.isSetImg()) {
      this.img = new Image(other.img);
    }
    this.score = other.score;
  }

  public GoodsObject deepCopy() {
    return new GoodsObject(this);
  }
  ...
  public GoodsObject setLabel( java.lang.String label) {
    this.label = label;
    return this;
  }
  ...
  public GoodsObject setDescription( java.lang.String description) {
    this.description = description;
    return this;
  }
  ...
  public GoodsObject setImg( Image img) {
    this.img = img;
    return this;
  }
  ...
  public GoodsObject setScore(double score) {
    this.score = score;
    setScoreIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof GoodsObject)
      return this.equals((GoodsObject)that);
    return false;
  }

  public boolean equals(GoodsObject that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(GoodsObject other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("GoodsObject(");
    boolean first = true;
  ...
  private static class GoodsObjectStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GoodsObjectStandardScheme getScheme() {
      return new GoodsObjectStandardScheme();
    }
  }

  private static class GoodsObjectStandardScheme extends org.apache.thrift.scheme.StandardScheme<GoodsObject> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GoodsObject struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GoodsObject struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GoodsObjectTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GoodsObjectTupleScheme getScheme() {
      return new GoodsObjectTupleScheme();
    }
  }

  private static class GoodsObjectTupleScheme extends org.apache.thrift.scheme.TupleScheme<GoodsObject> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GoodsObject struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GoodsObject struct) throws org.apache.thrift.TException {
